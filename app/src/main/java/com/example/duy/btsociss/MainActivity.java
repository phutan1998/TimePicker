package com.example.duy.btsociss;
...
public class MainActivity extends Activity {
    ...
    ArrayList<JoblnWeek>arrJob=new ArrayList<JoblnWeek>();
    //Khai báo ArrayAdapter cho ListView
    ArrayAdapter<JoblnWeek>adapter=null;
    ListView lvCv;
    Calendar cal;
    Date dateFinish;
    Date hourFinish;
    ...
    public void getFormWidgets()
    {
        ...
        adapter=new ArrayAdapter<JoblnWeek>
                (this,
    ...
    public void processAddJob()
    {
        ...
        JoblnWeek job=new JoblnWeek(title, description, dateFinish, hourFinish);
        arrJob.add(job);
        adapter.notifyDataSetChanged();
